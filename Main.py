...
def get_dc_hl(nuclide_name):
    ...
    half_life=get_nuclides_dataframe()[nuclide_name]
...
columns_exp_info[1].success('Half-life of the nuclide: ' +str(np.round(hl, 4)) + ' h     ||     Decay constant: ' + str(np.round(dc, 4)) + ' h$^{-1}$')
